...
const initTodos: Todo[] = [
  {
    ...
    text: "오늘 할 일",
    isChecked: false,
    createdAt: "09-17 21:24",
  },
  {
    todoId: 124,
    text: "출근하기...",
    isChecked: false,
    createdAt: "09-18 06:45",
  },
  {
    todoId: 980,
    text: "퇴근하기!",
    isChecked: false,
    createdAt: "09-18 18:02",
  },
];
...
function App() {
  ...
  return (
    <div className="App bg-bg flex justify-center items-center h-screen">
      <div className="flex flex-col h-5/6 w-1/2 bg-white py-4 text-center shadow-2xl text-default">
        <h1 className="text-default pb-4 text-3xl font-bold border-b-default border-gray-300">
          Todo List
        </h1>
        <ul className="flex-1">
          {todoItems.map((todo) => (
            <TodoItem key={todo.todoId} todo={todo} onClickTodo={onClickTodo} />
          ))}
        </ul>
